...
<div class="drawer lg:drawer-open">
  ...
  <div class="drawer-side">
    ...
    <ul
      class="menu menu-lg p-4 w-80 min-h-full bg-base-100 lg:border-r border-neutral-500 text-primary"
    >
      <li>
        <div
          class="normal-case menu-title text-xl font-bold text-primary flex flex-row"
        >
          <a href="/" class="grow">SaaS Quickstart</a>
      ...
      <li>
        <a
          href="/account"
          class={adminSection === "home" ? "bg-transparent text-white" : ""}
      ...
      <li>
        <a
          ...
          class={adminSection === "billing" ? "bg-transparent text-white" : ""}
          on:click={closeDrawer}
        >
          <svg
            class="h-5 w-5"
      ...
      <li>
        <a
          ...
          class={adminSection === "settings" ? "bg-transparent text-white" : ""}
          on:click={closeDrawer}
        >
