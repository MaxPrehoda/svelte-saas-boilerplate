...
export const pricingPlans = [
  ...
  },
  {
    ...
    price: "$5",
    priceIntervalName: "per month",
    stripe_price_id: "price_1OhbZ4AgGZYlcp7ia59OLLut",
    stripe_product_id: "prod_PWesQXAB0ebhQt",
    features: [
      "Everything in Free",
  ...
  },
  {
    ...
    price: "$15",
    priceIntervalName: "per month",
    stripe_price_id: "price_1OhbZeAgGZYlcp7i7rOUZfqz",
    stripe_product_id: "prod_PWetoRv4WCfn0o",
    features: [
      "Everything in Pro",
