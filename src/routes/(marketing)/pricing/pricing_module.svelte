  ...
  {#each pricingPlans as plan}
    <div
      class="flex-none card card-bordered {plan.id === highlightedPlanId
        ? 'border-pink-300'
        : 'border-neutral-500'} shadow-xl flex-1 flex-grow min-w-[260px] max-w-[310px] p-6 hover:scale-105 transition-all"
    >
      <div class="flex flex-col h-full">
        ...
        <div class="mt-auto pt-4 text-sm text-gray-100">
          Plan Includes:
        ...
        <div class="pt-8 text-gray-100">
          ...
          <span class="text-gray-100">{plan.priceIntervalName}</span>
